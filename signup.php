    ...
    <div class="st_cp2">
        ...
        <div class="form"> 
          ...
          <div class="form">
            ...
            <input type="password" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*?[0-9])(?=.*?[!@#$%^&*_+`~=?\|<>/]).{8,}" name ="password" id="password" placeholder="Enter Password">
          ...
          <div class="form">
           ...
           <div class="form2">
            ...
            <button type="submit" class="button"><a href="start.php" class="signup">Home Page</a></button>
